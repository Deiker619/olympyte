...
import { ArrowLeft, BookOpen, Calendar, CreditCard, MapPin, Phone, Users } from "lucide-react";
  ...
  useEffect(() => {
    ...
    const fetchEstudiante = async () => {
      try {
        ...
        setPagosEstudiante(resPagos.data.data);
      } catch (error) {
          ...
          <Card className="card-dashboard">
            ...
            <CardContent>
              <div className="space-y-4">
                {pagosEstudiante && pagosEstudiante.length > 0 ? (
                  ...
                  <EmptyState message="No hay pagos realizados" />
                )}
              </div>
            </CardContent>
          </Card>
