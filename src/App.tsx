...
import DetallesAsistencia from "./pages/dashboard/Asistencias/components/detallesAsistencia";
              ...
              <CursosProvider>
                <Routes>
                  ...
                  <Route element={<MainLayout />}>
                    ...
                    <Route path="/cursos/asistencias-detalles/:id" element={<DetallesAsistencia/>} />
